...
déplacer en utilisant $(v, \omega)$, le robot est contrôlable; mais il reste à plannifier, à plus haut niveau, ce que
...
sûr, c’était à nous, roboticiens, d’implémenter techniquement un comportement.
...
La solution aux problèmes évoquées ci-dessus a été d’utiliser la méthode des champs de potentiel. Dans ce paradigme, on
