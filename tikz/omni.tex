...
\begin{tikzpicture}[auto]
    ...
    \draw [<->, very thick] ($ (A) + (\r, \l) $) -- ($ (A) + (\r, -\l) $);
    \draw [<->, very thick] ($ (B) + (\r, \l) $) -- ($ (B) + (\r, -\l) $);
    \draw [<->, very thick] ($ (C) + (\r, \l) $) -- ($ (C) + (\r, -\l) $);
    \draw [<->, very thick] ($ (A) + (rot) $) arc (135:225:\r);
    \draw [<->, very thick] ($ (B) + (rot) $) arc (135:225:\r);
    \draw [<->, very thick] ($ (C) + (rot) $) arc (135:225:\r);
\end{tikzpicture}
